...
public class DeleteAddressCommand extends ErpCommand<Integer> {
	...
	public DeleteAddressCommand(final BusinessPartnerService service, final String businessPartnerId,
			final String addressId) {
		super(HystrixUtil.getDefaultErpCommandSetter(DeleteAddressCommand.class,
	...
	public Integer run() throws Exception {
		...
		final ODataDeleteResult oDataDeleteResult = service.deleteBusinessPartnerAddress(businessPartnerAddress)
				.execute();
