...
public class GetAllBusinessPartnersCommand extends CachingErpCommand<List<BusinessPartner>> {
	...
	private final Cache<CacheKey, List<BusinessPartner>> cache = CacheBuilder.newBuilder().maximumSize(50)
	...
	protected List<BusinessPartner> getFallback() {
		logger.warn("Fallback called bacause of exception:", getExecutionException());
