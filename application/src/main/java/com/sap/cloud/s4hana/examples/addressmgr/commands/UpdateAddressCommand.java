...
public class UpdateAddressCommand extends ErpCommand<Integer> {
	...
	public UpdateAddressCommand(final BusinessPartnerService service, final BusinessPartnerAddress addressToUpdate) {
		super(HystrixUtil.getDefaultErpCommandSetter(UpdateAddressCommand.class,
	...
	protected Integer run() throws Exception {
		final ODataUpdateResult oDataUpdateResult = service.updateBusinessPartnerAddress(addressToUpdate).execute();
